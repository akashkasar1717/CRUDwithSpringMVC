			...
			<div class="form-holder">
				...
				<div class="form-content">
					<div class="form-items">
						...
						         
						<form:form method="POST" action="/TutorialPoint/editsave">
							  
<!-- 							<div class="col-md-12"> -->
<%-- 								<form:input class="form-control" type="text" name="id" path="id" --%>
<%-- 									placeholder="ID"/> --%>
<!-- 							</div> -->

							<div class="col-md-12">
								<form:input class="form-control" type="text" name="fname"
									path="fname" placeholder="First Name"></form:input>
							</div>
							<div class="col-md-12">
								<form:input class="form-control" type="text" name="lname"
									path="lname" placeholder="Last Name" />
							</div>
							...
							<div class="col-md-12">
								<form:input class="form-control" type="text" name="pincode"
									path="pincode" placeholder="PinCode" />
							</div>

							<div class="col-md-12">
								<form:input class="form-control" type="text" name="mobile"
							...
							<div class="col-md-12">
								<form:input class="form-control" type="text" name="password"
							...
							<div class="form-button mt-3">
								<button id="submit" type="submit" value="save"
